    ...
    <main style="display:none;">
      ...
      <div class="form-group mt-4">
        <form ref="form" @submit.prevent="testNow">
          ...
          :init="{ menubar: false, height: 750 }"
          v-model="campaignData.html"
          />
          <span v-for="audience in audiences" :key="audience.id" style="margin-top: 30px; display:table;">
            <code>{{ campaignData.audience }}</code>
            <code v-if="audience.audience_name == campaignData.audience">
              <!-- {{ audience.contacts }} -->
              <input type="hidden" name="to_name" v-model="audience.contacts" class="form-control mb-2">
            </code>
          </span>

          <textarea style="display: none;" name="my_html" v-model="campaignData.html"></textarea>
          <input type="hidden" class="form-control mb-2" v-model="campaignData.status">
          <input type="hidden" class="form-control mb-2" v-model="campaignData.sending_date">
          <div class="form-group mt-3">
            <input type="submit" value="SEND" class="btn btn-primary" style="float:left; margin-right: 20px;">
...
export default {
    ...
    methods: {
        ...
        async getData() {
            ...
            // this.campaignData.staff = campaignData.staff
        },
