                ...
                <form @submit.prevent="updateCampaign">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="category" id="category" v-model="campaignData.category" class="form-select" aria-label="Default select example">
                            <option>{{ campaignData.category }}</option>
                            <option v-if="campaignData.category != 'SURVEYS'">SURVEYS</option>
                            <option v-if="campaignData.category != 'SALES'">SALES</option>
                            <option v-if="campaignData.category != 'OPERATIONS'">OPERATIONS</option>
                            <option v-if="campaignData.category != 'MARKETING'">MARKETING</option>
                        </select>
                    </div>
                    <div class="form-group mb-2">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <button type="submit" class="save-btn">UPDATE Campaign</button>
                    </div>
                </form>
            </section>
        </main>
